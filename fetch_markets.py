...
TICKERS = {
    ...
    # --- MSCI country indexes (iShares country ETFs — investable MSCI proxies) ---
    "ACWI": ("MSCI ACWI (All-Country World)", "bench"),
    "EWJ":  ("Japan", "country"),
    "EWG":  ("Germany", "country"),
    ...
    "EWI":  ("Italy", "country"),
    "EWP":  ("Spain", "country"),
    "EWN":  ("Netherlands", "country"),
    "EWL":  ("Switzerland", "country"),
    "EWD":  ("Sweden", "country"),
    ...
    "EWT":  ("Taiwan", "country"),
    "MCHI": ("China", "country"),
    "INDA": ("India (MSCI)", "country"),
    "EWZ":  ("Brazil", "country"),
    "EWW":  ("Mexico", "country"),
    "EIDO": ("Indonesia", "country"),
    "EWS":  ("Singapore", "country"),
    "EZA":  ("South Africa", "country"),
    "TUR":  ("Turkey", "country"),
    "EPOL": ("Poland", "country"),
